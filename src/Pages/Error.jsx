...
const ErrorPage = () => {
  return (
    <div className="h-screen err-body py-5">
      {/* <Helmet>
        <title>Academia Alliance | Error</title>
      </Helmet> */}
      <Link to={"/"} className="no-underline">
        <button className="bg-[#CA8787] text-white font-semibold cursor-pointer py-3 px-4 rounded-md w-fit mx-auto flex items-center justify-center hover:bg-black">
          Go Home
        </button>
      </Link>
